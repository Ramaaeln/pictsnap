...
export default function HeroSection() {
  return (
    <section className="dark:text-white  -my-16 h-screen w-full rounded-md  text-center content-center md:items-center md:justify-center dark:bg-black/[0.96] bg-[#FEFFD3] antialiased bg-grid-white/[0.02] relative overflow-hidden ">
      <Spotlight />
